	...
	theme: {
		...
		extend: {
			colors: {
				...
				'purple-luxury': 'hsl(var(--purple-luxury))',
			...
			keyframes: {
				...
				'glow-pulse': {
					'0%, 100%': { boxShadow: '0 0 20px hsl(var(--gold-primary) / 0.4)' },
					'50%': { boxShadow: '0 0 40px hsl(var(--gold-primary) / 0.8)' }
				},
				'fade-in-up': {
			...
			animation: {
				...
				'card-slide': 'card-slide 1s ease-out forwards',
				'card-open': 'card-open 0.8s ease-out forwards',
